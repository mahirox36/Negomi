...
class Guild(Hashable):
    ...
    async def create_text_channel(
        ...
        *,
        ...
        .. code-block:: python3
            ...
            overwrites = {
                guild.default_role: nexon.PermissionOverwrite(read_messages=False),
                guild.me: nexon.PermissionOverwrite(read_messages=True)
            }
    ...
    def bans(
        ...
        *,
        ...
        .. versionchanged:: 2.0
            Due to a breaking change in Discord's API, this now returns an :class:`~nexon.AsyncIterator` instead of a :class:`list`.
    ...
    def audit_logs(
        ...
        *,
        ...
        Getting entries for a specific action: ::
            ...
            async for entry in guild.audit_logs(action=nexon.AuditLogAction.ban):
    ...
    async def edit_widget(
        ...
        channel: Optional[:class:`~nexon.abc.Snowflake`]
