...
class User(Snowflake, Protocol):
    ...
    - :class:`~nexon.User`
    - :class:`~nexon.ClientUser`
    - :class:`~nexon.Member`

    This ABC must also implement :class:`~nexon.abc.Snowflake`.
...
class PrivateChannel(Snowflake, Protocol):
    ...
    - :class:`~nexon.DMChannel`
    - :class:`~nexon.GroupChannel`

    This ABC must also implement :class:`~nexon.abc.Snowflake`.

    Attributes
    ----------
    me: :class:`~nexon.ClientUser`
...
class GuildChannel:
    ...
    - :class:`~nexon.TextChannel`
    - :class:`~nexon.VoiceChannel`
    - :class:`~nexon.CategoryChannel`
    - :class:`~nexon.StageChannel`
    - :class:`~nexon.ForumChannel`
    ...
    def changed_roles(self) -> List[Role]:
        """List[:class:`~nexon.Role`]: Returns a list of roles that have been overridden from
        their default values in the :attr:`~nexon.Guild.roles` attribute."""
        ret = []
        g = self.guild
    ...
    def overwrites_for(self, obj: Union[Role, User]) -> PermissionOverwrite:
        ...
        Parameters
        ----------
        obj: Union[:class:`~nexon.Role`, :class:`~nexon.abc.User`]
            The role or user denoting
            whose overwrite to get.

        Returns
        -------
        :class:`~nexon.PermissionOverwrite`
    ...
    def overwrites(self) -> Dict[Union[Role, Member], PermissionOverwrite]:
        ...
        can be either a :class:`~nexon.Role` or a :class:`~nexon.Member` and the value is the
        overwrite as a :class:`~nexon.PermissionOverwrite`.

        Returns
        -------
        Dict[Union[:class:`~nexon.Role`, :class:`~nexon.Member`], :class:`~nexon.PermissionOverwrite`]
        ...
        for ow in self._overwrites:
            ...
            # i.e. adding nexon.Object to the list of it
    ...
    def category(self) -> Optional[CategoryChannel]:
        """Optional[:class:`~nexon.CategoryChannel`]: The category this channel belongs to.
    ...
    def permissions_for(self, obj: Union[Member, Role], /) -> Permissions:
        """Handles permission resolution for the :class:`~nexon.Member`
        or :class:`~nexon.Role`.
        ...
        If a :class:`~nexon.Role` is passed, then it checks the permissions
        ...
        Parameters
        ----------
        obj: Union[:class:`~nexon.Member`, :class:`~nexon.Role`]
    ...
    async def delete(self, *, reason: Optional[str] = None) -> None:
        ...
        You must have :attr:`~nexon.Permissions.manage_channels` permission to use this.
    ...
    async def set_permissions(
        ...
        **kwargs: Any,
        ...
        The ``target`` parameter should either be a :class:`~nexon.Member` or a
        :class:`~nexon.Role` that belongs to guild.

        The ``overwrite`` parameter, if given, must either be ``None`` or
        :class:`~nexon.PermissionOverwrite`. For convenience, you can pass in
        keyword arguments denoting :class:`~nexon.Permissions` attributes. If this is
        ...
        You must have the :attr:`~nexon.Permissions.manage_roles` permission to use this.
        ...
        Using :class:`~nexon.PermissionOverwrite` ::

            overwrite = nexon.PermissionOverwrite()
        ...
        Parameters
        ----------
        target: Union[:class:`~nexon.Member`, :class:`~nexon.Role`]
            The member or role to overwrite permissions for.
        overwrite: Optional[:class:`~nexon.PermissionOverwrite`]
        ...
        ~nexon.InvalidArgument
            ...
            :class:`~nexon.Role` or :class:`~nexon.Member`.
        """
    ...
    async def clone(self, *, name: Optional[str] = None, reason: Optional[str] = None) -> Self:
        ...
        You must have the :attr:`~nexon.Permissions.manage_channels` permission to
        do this.
    ...
    async def move(
        ...
        *,
        ...
        before: Optional[:class:`~nexon.abc.Snowflake`]
            The channel that should be before our current channel.
            This is mutually exclusive with ``beginning``, ``end``, and ``after``.
        after: Optional[:class:`~nexon.abc.Snowflake`]
        ...
        category: Optional[:class:`~nexon.abc.Snowflake`]
    ...
    async def create_invite(
        ...
        *,
        ...
        You must have the :attr:`~nexon.Permissions.create_instant_invite` permission to
        do this.
    ...
    async def invites(self) -> List[Invite]:
        ...
        You must have :attr:`~nexon.Permissions.manage_channels` to get this information.
...
class Messageable:
    ...
    - :class:`~nexon.User`
    - :class:`~nexon.Member`
    - :class:`~nexon.ext.commands.Context`
    - :class:`~nexon.Thread`
    """
    ...
    async def send(
        ...
        *,
        ...
        single :class:`~nexon.File` object. To upload multiple files, the ``files``
        parameter should be used with a :class:`list` of :class:`~nexon.File` objects.
        **Specifying both parameters will lead to an exception**.

        To upload a single embed, the ``embed`` parameter should be used with a
        single :class:`~nexon.Embed` object. To upload multiple embeds, the ``embeds``
        parameter should be used with a :class:`list` of :class:`~nexon.Embed` objects.
        **Specifying both parameters will lead to an exception**.
        ...
        embed: :class:`~nexon.Embed`
            The rich embed for the content.
        file: :class:`~nexon.File`
            The file to upload.
        files: List[:class:`~nexon.File`]
        ...
        allowed_mentions: :class:`~nexon.AllowedMentions`
        ...
        reference: Union[:class:`~nexon.Message`, :class:`~nexon.MessageReference`, :class:`~nexon.PartialMessage`]
            A reference to the :class:`~nexon.Message` to which you are replying, this can be created using
            :meth:`~nexon.Message.to_reference` or passed directly as a :class:`~nexon.Message`. You can control
            whether this mentions the author of the referenced message using the :attr:`~nexon.AllowedMentions.replied_user`
            attribute of ``allowed_mentions`` or by setting ``mention_author``.

            .. versionadded:: 1.6

        mention_author: Optional[:class:`bool`]
            If set, overrides the :attr:`~nexon.AllowedMentions.replied_user` attribute of ``allowed_mentions``.

            .. versionadded:: 1.6
        view: :class:`nexon.ui.View`
            A Discord UI View to add to the message.
        embeds: List[:class:`~nexon.Embed`]
            A list of embeds to upload. Must be a maximum of 10.

            .. versionadded:: 2.0
        stickers: Sequence[Union[:class:`~nexon.GuildSticker`, :class:`~nexon.StickerItem`]]
        ...
        ~nexon.InvalidArgument
            ...
            or the ``reference`` object is not a :class:`~nexon.Message`,
            :class:`~nexon.MessageReference` or :class:`~nexon.PartialMessage`
    ...
    async def fetch_message(self, id: int, /) -> Message:
        ...
        Retrieves a single :class:`~nexon.Message` from the destination.
    ...
    def history(
        ...
        *,
        ...
        You must have :attr:`~nexon.Permissions.read_message_history` permissions to use this.
        ...
        before: Optional[Union[:class:`~nexon.abc.Snowflake`, :class:`datetime.datetime`]]
            Retrieve messages before this date or message.
            If a datetime is provided, it is recommended to use a UTC aware datetime.
            If the datetime is naive, it is assumed to be local time.
        after: Optional[Union[:class:`~nexon.abc.Snowflake`, :class:`datetime.datetime`]]
            Retrieve messages after this date or message.
            If a datetime is provided, it is recommended to use a UTC aware datetime.
            If the datetime is naive, it is assumed to be local time.
        around: Optional[Union[:class:`~nexon.abc.Snowflake`, :class:`datetime.datetime`]]
    ...
    async def connect(
        ...
        *,
        ...
        cls: Type[:class:`VoiceProtocol`]
            A type that subclasses :class:`~nexon.VoiceProtocol` to connect with.
            Defaults to :class:`~nexon.VoiceClient`.

        Raises
        ------
        asyncio.TimeoutError
            Could not connect to the voice channel in time.
        ~nexon.ClientException
            You are already connected to a voice channel.
        ~nexon.opus.OpusNotLoaded
            The opus library has not been loaded.

        Returns
        -------
        :class:`~nexon.VoiceProtocol`
