...
if TYPE_CHECKING:
    ...
    from nexon.abc import MessageableChannel
    from nexon.guild import Guild
    from nexon.member import Member
    from nexon.state import ConnectionState
    from nexon.user import ClientUser, User
    from nexon.voice_client import VoiceProtocol
...
class Context(nexon.abc.Messageable, Generic[BotT]):
    ...
    This class implements the :class:`~nexon.abc.Messageable` ABC.
    ...
    async def _get_channel(self) -> nexon.abc.Messageable:
        return self.channel
    ...
    def author(self) -> Union[User, Member]:
        """Union[:class:`~nexon.User`, :class:`.Member`]:
    ...
    @nexon.utils.copy_doc(Message.reply)
