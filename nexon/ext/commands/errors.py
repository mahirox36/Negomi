...
from nexon.errors import ClientException, DiscordException

if TYPE_CHECKING:
    from inspect import Parameter

    from nexon.abc import GuildChannel
    from nexon.threads import Thread
...
class CommandError(DiscordException):
    ...
    This inherits from :exc:`nexon.DiscordException`.
...
class ConversionError(CommandError):
    ...
    Attributes
    ----------
    converter: :class:`nexon.ext.commands.Converter`
...
class CommandRegistrationError(ClientException):
    ...
    This inherits from :exc:`nexon.ClientException`
...
class TooManyFlags(FlagError):
    ...
    Attributes
    ----------
    flag: :class:`~nexon.ext.commands.Flag`
