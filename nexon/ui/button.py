...
class Button(Item[V_co]):
    ...
    def style(self) -> ButtonStyle:
        """:class:`nexon.ButtonStyle`: The style of the button."""
...
def button(
    *,
    ...
    the :class:`nexon.ui.View`, the :class:`nexon.ui.Button` being pressed and
    the :class:`nexon.Interaction` you receive.
