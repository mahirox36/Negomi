...
class MentionableSelectValues(SelectValuesBase):
    ...
    def users(self) -> List[User]:
        """List[:class:`nexon.User`]: A list of users that were selected."""
...
class MentionableSelect(SelectBase, Generic[V_co]):
    ...
    def values(self) -> MentionableSelectValues:
        """:class:`.ui.MentionableSelectValues`: A list of Union[:class:`.Member`, :class:`nexon.User`, :class:`.Role`] that have been selected by the user."""
