...
export default function ServerManagement() {
  ...
  const quickLinks = [
    {
      name: "Basic Settings",
      href: `/dashboard/server/${params.id}/settings`,
      description: "Configure basic bot settings and preferences",
    },
    {
      name: "Welcome Messages",
      href: `/dashboard/server/${params.id}/welcome`,
      description: "Set up custom welcome messages for new members",
    },
    {
      name: "Auto Moderation",
      href: `/dashboard/server/${params.id}/automod`,
      description: "Configure automated moderation rules",
    },
    {
      name: "Logging",
      href: `/dashboard/server/${params.id}/logging`,
      description: "Set up event logging channels and filters",
    },
  ];
