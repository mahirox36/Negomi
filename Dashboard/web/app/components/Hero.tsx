    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <motion.div className="overflow-hidden">
          ...
          >
            <motion.span
              className="inline-block px-2" // Added horizontal padding
        ...
        <motion.div variants={floatingAnimation}>
          ...
          >
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="relative px-8 py-4 bg-white rounded-full font-bold text-lg text-purple-600 transition-colors duration-200 hover:text-purple-700"
            >
              Add to Discord
            </motion.div>
          </Link>
