            ...
            "settings": [
                {
                    ...
                    "description": "Color for common badges",
                },
                {
...
async def get_server_sidebar():
    ...
    return {
        ...
        "Features": [
            ...
            # {"name": "Welcome", "link": "welcome", "icon": "fa-solid fa-gift"},
            # {
            #     "name": "Leveling",
            #     "link": "leveling",
            #     "icon": "fa-solid fa-trophy"
            # },
            {"name": "Badges", "link": "badges", "icon": "fa-solid fa-medal"},
        ],
    }
